...
###Know your limits
Go easy on the API limits, keep the range of actions 'normal' and random.  Just because there is a technical limit, doesn't mean you should brush against it.  The Instagram limit for number of likes in an hour is 100, however 60 likes in an hour is 40% less than the limit and is a much more reasonable cadence. 